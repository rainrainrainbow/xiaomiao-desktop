...
static const char *s_zh[STR_COUNT] = {
    ...
    [STR_SHELL_WELCOME]    = "XiaoMiao Shell\n输入 help 查看命令",
    [STR_SHELL_INPUT]      = "输入",
    [STR_SHELL_HELP]       = "帮助",
    [STR_SHELL_UNKNOWN]    = "未知命令",
    [STR_SHELL_SCROLL]     = "滚动",
    [STR_SHELL_AVAIL]      = "可用命令:",
    [STR_SHELL_CODE]       = "代码",
    [STR_SHELL_TITLE]      = "命令",
    [STR_STATUS_READY]         = "就绪",
...
static const char *s_en[STR_COUNT] = {
    ...
    [STR_SHELL_INPUT]      = "Input",
    [STR_SHELL_HELP]       = "Help",
    [STR_SHELL_UNKNOWN]    = "Unknown cmd",
    [STR_SHELL_SCROLL]     = "Scroll",
    [STR_SHELL_AVAIL]      = "Available commands:",
    [STR_SHELL_CODE]       = "code",
    [STR_SHELL_TITLE]      = "Command",
