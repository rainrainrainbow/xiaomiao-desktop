...
const app_entry_t g_builtin_apps[] = {
    { .id = "settings", .name = "设置",  .icon = "⚙️", .icon_bg = lv_color_hex(0x667eea), .create = NULL },
    { .id = "files",    .name = "文件",  .icon = "📁", .icon_bg = lv_color_hex(0xf093fb), .create = NULL },
    { .id = "game",     .name = "贪吃蛇",.icon = "🐍", .icon_bg = lv_color_hex(0x4facfe), .create = snake_create },
    { .id = "music",    .name = "音乐",  .icon = "🎵", .icon_bg = lv_color_hex(0x43e97b), .create = music_player_create },
    { .id = "calc",     .name = "计算器",.icon = "🔢", .icon_bg = lv_color_hex(0xfa709a), .create = calc_create },
    { .id = "tasks",    .name = "任务",  .icon = "📋", .icon_bg = lv_color_hex(0xff9a9e), .create = NULL },
};
